...
class kdrama(models.Model):
    ...
    actors = models.ManyToManyField('actor', related_name='kdramas', blank=True)
    directors = models.ManyToManyField('director', related_name='kdramas', blank=True)
    prod_companies = models.ManyToManyField('prod_company', related_name='kdramas', blank=True)
    awards = models.ManyToManyField('award', related_name='kdramas', blank=True)
